...
import UIKit
import CoreLocation
class UISendImageControllerView: UIViewController {
...
//        locationManager.requestLocation()
    ...
    func sayImagen(){
        ...
        imagenSolicitud.layer.shadowOpacity = 1
        imagenSolicitud.layer.shadowRadius = 5

        imagenSolicitud.layer.cornerRadius = 15 //btnTomarFoto.frame.width/2
        imagenSolicitud.layer.masksToBounds = false
    }
...
extension UISendImageControllerView: SolicitudManagerDelegate{
...
extension UISendImageControllerView: UIImagePickerControllerDelegate & UINavigationControllerDelegate {
...
extension UISendImageControllerView: UITextFieldDelegate{
...
extension UISendImageControllerView: CLLocationManagerDelegate{
