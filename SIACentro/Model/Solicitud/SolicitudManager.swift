...
struct SolicitudManager{
    ...
    // Envia un mensaje
    func postRequestMessage(permissionData: String, user_id: Int, respuesta: String, denunciamobile_id: String  ) {
        
        let S = Singleton.shared
        let getUrlAPISendSolicitud: String = S.getUrlAPISendMessage()

        let parameters = [
            "respuesta": respuesta,
            "denunciamobile_id": denunciamobile_id,
            "user_id": user_id
        ] as [String : Any]
